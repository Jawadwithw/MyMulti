...
public class ColleagueOrdersViewModel extends AndroidViewModel {
    private Dialog dialog;
    private DialogGenerator dialogGenerator;

    public ColleagueOrdersViewModel(@NonNull Application application) {
        super(application);
       // dialog = dialogGenerator.progressDialog(application);
    ...
    void getOrders(Context context, String user_name, int page, int limit, final OnParseObjectReceived onParseObjectReceived){
        ...
        query.whereEqualTo(OrderActivity.IS_MY_ORDER,false);
